...
public class ZipFile {
     ...
     * @throws ZipException
     */
    public void createZipFileFromFolders(ArrayList<File> sourceFolderList, ZipParameters parameters, boolean splitArchive, long splitLength) throws ZipException {
     ...
     * @throws ZipException
     */
    private void addFolders(ArrayList<File> foldersList, ZipParameters parameters, boolean checkSplitArchive) throws ZipException {
     ...
     * not exist, then this method throws an exception.<br><br>
